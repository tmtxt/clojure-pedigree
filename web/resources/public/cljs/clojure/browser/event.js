...
clojure.browser.event.IEventType = (function (){var obj12431 = {};
return obj12431;
})();
...
return (function (){var or__4093__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4729__auto__)]);
if(or__4093__auto__){
return or__4093__auto__;
} else {
var or__4093__auto____$1 = (clojure.browser.event.event_types["_"]);
...
var k = cljs.core.nth.call(null,vec__12435,(0),null);
var v = cljs.core.nth.call(null,vec__12435,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
