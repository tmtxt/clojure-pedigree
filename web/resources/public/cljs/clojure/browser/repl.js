...
return (function (){
if(cljs.core.truth_((function (){var and__4081__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__12424 = script;
(G__12424["type"] = "text/javascript");

(G__12424["onload"] = onload);

(G__12424["onreadystatechange"] = onload);

return G__12424;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__12425 = script__$1;
(G__12425["src"] = src);

return G__12425;
})():(function (){var G__12426 = script__$1;
goog.dom.setTextContext(G__12426,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4093__auto__ = reload;
...
var path_12427 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_12427];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_12427)].join('')];
} else {
}
